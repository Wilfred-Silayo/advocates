    ...
    <div class="row text-white fs-5 pe-2">
        <div class="col-12 col-md-6 mb-4">
            ...
            <ul class="list-unstyled ps-2 pe-2">
                ...
                <li class="p-2 ">We assist our clients to navigate privacy and data protection compliance</li>
                <li class="p-2 ">Professional privacy and data protection training</li>
                <li class="p-2 ">Handling Data Subject Access Request (DSAR)</li>
                <li class="p-2 ">We guide our clients on International Data Transfer</li>
                <li class="p-2 ">Data Protection Officer (DPO) as a service</li>
                <li class="p-2 ">Incidence Response as a service</li>
                <li class="p-2 ">Privacy and data protection Advisory</li>
            </ul>
        </div>
        <div class="col-12 col-md-6 mb-4">
            ...
            <ul class="list-unstyled ps-2 pe-2">
                ...
                <li class="p-2 ">Security services</li>
                <li class="p-2 ">Cybersecurity incident response services</li>
                <li class="p-2 ">Cybersecurity training</li>
        </div>
    </div>
    <div class="row text-white fs-5 pe-2">
        <div class="col-12 col-md-6 mb-4">
